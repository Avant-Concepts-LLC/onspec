...
"""
# Embeddable fragment for onspec.sh: scales the fixed poster to the container width.
embed = f"""<!-- generated by docs/design/gen_diagram.py — do not hand-edit -->
<div class="how-poster" style="position:relative; width:100%; aspect-ratio:{W} / {H}; overflow:hidden; border:1px solid #1e232c; border-radius:10px;">
  <div class="how-poster-inner" style="position:absolute; left:0; top:0; width:{W}px; height:{H}px; transform-origin:0 0;">
{poster}
  </div>
</div>
<script>(function(){{var p=document.querySelector('.how-poster'),i=p&&p.querySelector('.how-poster-inner');if(!i)return;function f(){{i.style.transform='scale('+(p.clientWidth/{W})+')';}}f();addEventListener('resize',f);}})();</script>
"""
